...
export const categories: Category[] = [
  {
    ...
    picks: [
      ...
      { product: 'Ultrahuman Ring AIR', brand: 'Ultrahuman', url: 'https://www.ultrahuman.com/', affiliate: true, reviewSlug: 'ultrahuman-ring-air',
      ...
      { product: 'Withings ScanWatch 2', brand: 'Withings', url: 'https://www.withings.com/', affiliate: true, reviewSlug: 'withings-scanwatch-2',
  ...
  },
  {
    ...
    picks: [
      { product: 'Theragun Prime Plus', brand: 'Therabody', url: 'https://www.amazon.de/dp/B0DDYWM7PV?tag=sqwod-21', affiliate: true, reviewSlug: 'theragun-prime-plus',
      ...
      { product: 'BLACKROLL Standard', brand: 'BLACKROLL', url: 'https://blackroll.com/products/blackroll-standard', affiliate: true, reviewSlug: 'blackroll-standard',
  ...
  },
  {
    ...
    picks: [
      ...
      { product: 'ESN Designer Whey', brand: 'ESN', url: 'https://www.esn.com/', affiliate: true, reviewSlug: 'esn-designer-whey',
