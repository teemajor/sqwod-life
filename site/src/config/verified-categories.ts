...
export const categories: Category[] = [
  {
    ...
    picks: [
      ...
      { product: 'COROS PACE 3', brand: 'COROS', url: 'https://coros.com/', affiliate: true, reviewSlug: 'coros-pace-3',
  ...
  },
  {
    ...
    picks: [
      ...
      { product: 'Manta Sleep Mask', brand: 'Manta Sleep', url: 'https://mantasleep.com/', affiliate: true, reviewSlug: 'manta-sleep-mask',
      ...
      { product: 'Loop Quiet 2', brand: 'Loop', url: 'https://www.loopearplugs.com/', affiliate: true, reviewSlug: 'loop-quiet-2',
  ...
  },
  {
    ...
    picks: [
      ...
      { product: 'ESN Ultrapure Creatine', brand: 'ESN', url: 'https://www.esn.com/', affiliate: true, reviewSlug: 'esn-ultrapure-creatine',
      ...
      { product: 'Optimum Nutrition Gold Standard', brand: 'Optimum Nutrition', url: 'https://www.optimumnutrition.com/', affiliate: true, reviewSlug: 'optimum-nutrition-gold-standard',
  ...
  },
  {
    ...
    picks: [
      ...
      { product: 'Concept2 RowErg', brand: 'Concept2', url: 'https://www.concept2.com/de', affiliate: true, reviewSlug: 'concept2-rowerg',
