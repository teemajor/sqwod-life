---
urlSlug: creatine-evidence-coach-playbook
lang: "de"
counterpart: creatine-evidence-coach-playbook
title: "Deine Kunden fragen ständig nach Kreatin. Hier ist die Evidenz — und das Skript."
description: "Wir haben die Meta-Analysen gelesen, bewertet und geprüft, was noch erforscht wird. Was Kreatin wirklich bringt, was nicht — und was du dem Kunden sagst, der fragt."
pillar: move
type: evidence
format: analysis
conversion: products
...
sources:
  ...
  - { label: "Candow et al. 2024 — Dosing review (Advanced Exercise & Health Science) · DOI 10.1016/j.aehs.2024.05.002", url: "https://consensus.app/papers/details/a21e5a65b6c05da79a9eca58809239aa/" }
...
figures:
  - { label: "Kraftzuwachs Oberkörper vs. Placebo", value: "+4.43 kg", note: "Gewichtete mittlere Differenz, Kreatin + Krafttraining, Erwachsene unter 50", source: "Wang et al. 2024, Nutrients (23 studies)", url: "https://consensus.app/papers/details/6ff33354c09057cbafded17affbd503b/" }
  - { label: "Kraftzuwachs Unterkörper vs. Placebo", value: "+11.35 kg", note: "Gewichtete mittlere Differenz, Kreatin + Krafttraining", source: "Wang et al. 2024, Nutrients", url: "https://consensus.app/papers/details/6ff33354c09057cbafded17affbd503b/" }
  - { label: "Verbesserung des Gedächtnisses (alle Erwachsenen)", value: "SMD 0.31", note: "Kleiner bis moderater Effekt; GRADE-Sicherheit: moderat. Größer bei älteren Erwachsenen (SMD 0.88)", source: "Xu et al. 2024; Prokopidis et al. 2022", url: "https://consensus.app/papers/details/54813b2512da51388b5b582d3efdfa9d/" }
  - { label: "Niedrigere Kreatinspeicher bei Frauen vs. Männern", value: "70–80%", note: "Warum Ladephase und ausreichende Dosierung für weibliche Kunden wichtiger sein können", source: "Smith-Ryan et al. 2021, Nutrients", url: "https://consensus.app/papers/details/f77816eefe0e5585af43261750c0f28e/" }
  - { label: "Effekt auf DHT & Haare über 12 Wochen", value: "No difference", note: "Erstes RCT, das die Haarfollikel-Gesundheit direkt gemessen hat; keine Veränderung vs. Placebo", source: "Lak et al. 2025, JISSN", url: "https://consensus.app/papers/details/f1512181e38958baa713a6587cda267e/" }
  - { label: "Kreatin-Studien, die rekrutieren oder kurz davorstehen", value: "60+", note: "Laufende Pipeline (Stand Juli 2026) — die Fragen, die die Forschung als Nächstes beantwortet", source: "ClinicalTrials.gov", url: "https://clinicaltrials.gov/search?intr=creatine%20monohydrate&aggFilters=status:not%20rec" }
playbook:
  - { move: "Standard-Empfehlung: 5 g Kreatin-Monohydrat pro Tag, jeden Tag, Zeitpunkt egal.", why: "Es ist die einzige Form mit breiter Evidenz, und die Erhaltungsdosis füllt die Speicher in ~3–4 Wochen ohne Ladephase (Candow 2024). Einfacher = bessere Adhärenz." }
  - { move: "Entkräfte den Haarausfall-Einwand direkt mit dem RCT von 2025.", why: "Es ist der häufigste Grund, warum männliche Kunden Kreatin heimlich weglassen. Eine kleine Studie von 2009 zu einem Hormon-Marker hat den Mythos gestartet; ein RCT von 2025 hat die Haare direkt gemessen — kein Effekt (Lak 2025)." }
...
changelog:
  - { date: "2026-07-06", note: "Erste Ausgabe. Evidenz aktuell bis Juli 2026; nach Studienqualität bewertet. Wir aktualisieren, sobald die Pipeline liefert." }
---
