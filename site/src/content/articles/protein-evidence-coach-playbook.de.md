...
title: "Deine Kunden zerdenken das Protein-Timing. Das bewegt wirklich etwas."
description: "Wir haben die Dosis-Wirkungs-Meta-Analysen, das ISSN-Positionspapier und die Timing-Studien gelesen und bewertet. Wie viel Protein wirklich Muskeln baut, ob das anabole Fenster real ist — und was du dem Kunden sagst, der fragt."
pillar: move
type: evidence
format: analysis
conversion: products
...
hero:
  kind: lattice
  stat: "1,6 g/kg"
  statLabel: "die Tageszahl, die die Arbeit macht"
verdict:
  title: "Protein: Was stimmt wirklich?"
  real:
    - { value: "1,6g/kg", text: "triff deinen Tagesgesamtwert — das treibt die Gewinne" }
    - { value: "+ Training", text: "Protein baut Kraft nur zusammen mit Krafttraining auf" }
  hype:
...
Kein Supplement erzeugt mehr Aufregung pro Gramm als Protein. Kunden takten ihr Post-Workout-Fenster auf die Minute, streiten über Whey versus Casein und kaufen den teuren Blend — während sie ihren Tagesgesamtwert still um 40 Gramm verfehlen. Die Energie zielt auf die Nachkommastellen und weg von der Zahl, die wirklich zählt.

Also haben wir das Unspektakuläre, aber Wertvolle getan: die Dosis-Wirkungs-Meta-Analysen, das ISSN-Positionspapier und die Timing-Studien gelesen, bewertet und im Register geprüft, was noch offen ist. Hier ist, was wirklich etwas bewegt — so geschrieben, dass du es heute mit einem Kunden nutzen kannst, nicht um eine Ernährungsprüfung zu bestehen.

Ein Hinweis vorweg: Protein ist der seltene Bereich, in dem die Wissenschaft bei der großen Frage wirklich geklärt und bei den kleinen wirklich nuanciert ist. Dein Job als Coach ist, zuerst die große Frage richtig zu machen — und erst dann Aufmerksamkeit auf die Details zu verwenden, die sie sich verdienen.

## Die einzige Zahl, die wirklich zählt: der Tagesgesamtwert

Wenn ein Kunde eine Sache richtig macht, dann diese. Über die kontrollierte Evidenz hinweg ist das Tagesgesamtprotein der stärkste Prädiktor dafür, wie viel Muskeln und Kraft jemand aufbaut. Die International Society of Sports Nutrition setzt den wirksamen Bereich auf **1,4–2,0 g/kg/Tag** zum Aufbau und Erhalt von Muskeln, wobei höhere Zufuhren vor allem nützen, um im Defizit Magermasse zu halten.<sup class="fn"><a href="#source-1">1</a></sup> Eine Meta-Analyse aus 74 Studien fand, dass mehr Protein bei Menschen, die trainieren, einen kleinen, aber realen Zuwachs an fettfreier Masse brachte (**SMD 0,22**), und benannte die Schwellen, ab denen es zählt: rund **≥1,6 g/kg** unter 65 und **≥1,2 g/kg** bei Älteren.<sup class="fn"><a href="#source-3">3</a></sup>
...
Das ist der Vorbehalt, der das ganze Gespräch neu rahmt. In derselben Dosis-Wirkungs-Meta-Analyse steigerte zusätzliches Protein die Kraft **nur zusammen mit Krafttraining** — ohne nennenswerten Kraftzuwachs durch Protein allein.<sup class="fn"><a href="#source-2">2</a></sup> Protein ist kein Kraft-Supplement; es ist das Rohmaterial, das Training in Anpassung übersetzt.

Das ist ein nützlicher Satz für einen Kunden, der drei Shakes am Tag trinkt und sich wundert, warum nichts passiert. Der Shake baut nicht den Muskel. Das Training tut es — und das Protein sorgt dafür, dass der Aufbau nicht am fehlenden Material scheitert.

**Evidenzgrad: stark.** Die Trainingsvoraussetzung ist einer der konsistentesten Befunde der Literatur.

## Das anabole Fenster ist großteils ein Mythos — für die meisten Kunden
...
**Evidenzgrad: stark**, dass Timing für typische Trainierende der Gesamtzufuhr nachgeordnet ist. Rahme das Fenster als Flexibilität, nicht als Deadline.

## Wo Timing wirklich zählt: deine älteren Kunden

Jetzt die ehrliche Ausnahme, denn ein guter Coach weiß, wann die Regel kippt. Bei Menschen mit **anaboler Resistenz** — am offensichtlichsten Ältere — beginnt es zu zählen, wann man Protein isst. Eine klassische Studie an älteren Männern ließ beide Gruppen dieselben 12 Wochen Krafttraining absolvieren und dasselbe Protein nehmen, aber die eine Gruppe nahm es **direkt nach** dem Training und die andere **zwei Stunden später**. Nur die Sofort-Gruppe gewann Muskelquerschnitt; die verzögerte Gruppe wuchs nicht.<sup class="fn"><a href="#source-8">8</a></sup>
...
Sitzt der Tagesgesamtwert, ist das das wertvollste Detail. Die praktische ISSN-Empfehlung lautet **~0,25 g/kg (rund 20–40 g) pro Mahlzeit, alle 3–4 Stunden**, wobei jede Dosis genug Leucin (~700–3000 mg) aus einem vollständigen Protein trägt, um die Muskelproteinsynthese voll einzuschalten.<sup class="fn"><a href="#source-1">1</a></sup> Die meisten laden beim Frühstück fast nichts und kippen ihr Protein ins Abendessen — genau das Muster, das man beheben sollte.

Eine 12-Wochen-Studie zeigte es direkt: Protein gleichmäßig über den Tag zu verteilen (statt es aufs Abendessen zu schieben) brachte tendenziell größere Zuwächse an Magergewebe, mit großer Effektstärke.<sup class="fn"><a href="#source-7">7</a></sup> Gleicher Tagesgesamtwert, besseres Ergebnis, nur durchs Verteilen. Ein kostenloser Gewinn, den du coachen kannst, ohne dass jemand etwas kauft.

**Evidenzgrad: moderat.** Die Dosis pro Mahlzeit ist gut gestützt; der Verteilungsvorteil ist real, aber aus kleineren Studien.
...
*Sqwod liest die Forschung, damit deine Kunden es nicht müssen. Das sind Coaching-Informationen, keine medizinische Beratung; alles rund um Erkrankungen, Schwangerschaft, Medikamente oder die Nieren gehört zu einer qualifizierten Fachperson. Etwas gefunden, das schärfer sein müsste? So bleibt eine Evidenzseite ehrlich — sag es uns, und wir korrigieren es öffentlich.*
