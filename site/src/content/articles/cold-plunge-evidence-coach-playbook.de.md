...
title: "Die Eisbad-Frage: Was die Evidenz wirklich hergibt — und wann Kälte gegen deinen Kunden arbeitet"
description: "Wir haben die Meta-Analysen zum Kaltwasserbad gelesen, bewertet und das Studienregister geprüft. Was es für die Regeneration bringt, was es dich an Muskelaufbau kostet — und was du dem Kunden sagst, der sich gerade eine Eistonne gekauft hat."
pillar: signal
type: evidence
format: analysis
...
figures:
  ...
  - { label: "Kaltwasser-Studien, die rekrutieren oder kurz davorstehen", value: "7", note: "Laufendes Register, Stand Juli 2026 — eine erstaunlich kleine Pipeline für einen sehr lauten Trend", source: "ClinicalTrials.gov", url: "https://clinicaltrials.gov/search?intr=%22cold+water+immersion%22&aggFilters=status:not%20rec" }
playbook:
  - { move: "Kläre das Ziel, bevor du die Tonne empfiehlst: Geht es um schnelle Erholung oder um Muskelaufbau?", why: "Dieselbe Maßnahme hilft dem einen Ziel und steht dem anderen im Weg. Kälte nach einem Spiel oder Wettkampf ist gestützt (Veen 2026); Kälte direkt nach einer Hypertrophie-Einheit dämpft genau die Anpassung, für die trainiert wurde (Piñero 2024)." }
  - { move: "Geht es um Regeneration: 10–15 Minuten bei 11–15 °C — nicht kälter, nicht länger.", why: "Dieser Bereich lag in der Netzwerk-Meta-Analyse aus 55 RCTs bei der Muskelkater-Reduktion vorn. Kälter ist nicht besser, sondern nur unangenehmer und im Freiwasser gefährlicher (Wang 2025)." }
  - { move: "Wenn ein Kunde beides will: 4–6 Stunden Abstand zwischen Krafttraining und Bad legen.", why: "Die Dämpfungsdaten stammen aus Bädern unmittelbar nach der Belastung. Der zeitliche Abstand ist der praktische Kompromiss — dass er den Effekt vollständig aufhebt, ist nicht belegt. Sag das ehrlich dazu." }
  - { move: "Einsteiger über mehrere Einheiten heranführen — und niemals allein baden lassen.", why: "Die Kälteschockreaktion (Schnappatmung, Hyperventilation, Herzfrequenzanstieg) ist die reale Gefahr. Sie gewöhnt sich nach rund vier Expositionen ab, die Herzfrequenzreaktion sinkt um 14 Schläge/Min (Barwood 2023). Progressive Gewöhnung ist ein Sicherheitsprotokoll, keine Weichspülerei." }
...
verdict:
  title: "EISBAD: WAS IST DRAN?"
  realLabel: "Gestützt"
  hypeLabel: "Nicht gestützt"
  real:
    - { value: "SMD −1,45", text: "Weniger Muskelkater bei 10–15 Min / 11–15 °C" }
    - { value: "SMD 1,02", text: "Krafterholung nach dem Spiel" }
    - { value: "~4", text: "Bäder bis die Kälteschockreaktion nachlässt" }
  hype:
    - { value: "−0,22", text: "Hypertrophie nach dem Krafttraining gedämpft" }
    - { value: "Nein", text: "Relevanter Fettabbau über braunes Fett" }
    - { value: "n.s.", text: "Stimmungseffekt in der gepoolten Meta-Analyse" }
  note: "PLOS ONE · Frontiers in Physiology · EJSS — siehe Quellen"
tags: ["cold-plunge", "eisbad", "kaltwasser", "regeneration", "evidence", "coaching"]
changelog:
  - { date: "2026-07-20", note: "Erste Ausgabe. Evidenz aktuell bis Juli 2026; nach Studienqualität bewertet. Wir aktualisieren, sobald die Pipeline liefert." }
---
...
Eine wichtige Nuance, die aus dem Ganzen kein pauschales Verbot macht: Eine Studie von 2019 fand das **Wachstum der Typ-II-Fasern gedämpft**, während sich die **1RM-Beinpresse in beiden Gruppen praktisch gleich verbesserte**.<sup class="fn"><a href="#source-4">4</a></sup> Maximalkraft ist ebenso eine Nerven- und Technikgeschichte wie eine Frage des Querschnitts — und offenbar robuster gegenüber Kälte als die Hypertrophie. Ein Kraftsportler in einer schweren Wettkampfphase hat hier also mehr Spielraum als eine Kundin, die sichtbaren Muskelaufbau will.
...
Aber ein systematisches Review von 47 klinischen Studien zu Maßnahmen, die braunes Fettgewebe aktivieren, kam zu dem Schluss, dass die beobachteten Veränderungen des Energieverbrauchs **nicht mit relevanten Gewichtsveränderungen zusammenhingen** — und dass Kälteexposition als nachhaltige Strategie gegen Adipositas unwahrscheinlich ist.<sup class="fn"><a href="#source-10">10</a></sup> Die beteiligte Energiemenge ist klein, das Verhalten schwer durchzuhalten, und die Rechnung geht nicht auf.
